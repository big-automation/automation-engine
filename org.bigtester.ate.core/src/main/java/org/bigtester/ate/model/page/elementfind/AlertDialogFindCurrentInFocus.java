...
public class AlertDialogFindCurrentInFocus extends BaseAlertDialogFinderImpl 
	...
	public AbstractAlertDialog doFind(IMyWebDriver myWebDriver) throws NoSuchElementException {
		AbstractAlertDialog retVal = myWebDriver.getMultiWindowsHandler().obtainFocusOnLatestAlertDialog();
		if (null == retVal) {
			throw new NoSuchElementException("Alert dialog in current focus");
		}  
		return retVal;
	}
	/**
