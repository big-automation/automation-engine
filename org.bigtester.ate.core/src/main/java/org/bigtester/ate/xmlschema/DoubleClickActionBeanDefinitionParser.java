...
import org.bigtester.ate.model.page.elementaction.DoubleClickAction;
 ...
 *
 */
public class DoubleClickActionBeanDefinitionParser extends
	...
	protected @Nullable AbstractBeanDefinition parseInternal(
		...
		bDef.setBeanClassName(DoubleClickAction.class.getName());
