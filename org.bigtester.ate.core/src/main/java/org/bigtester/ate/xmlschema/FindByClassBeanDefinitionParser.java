...
import org.bigtester.ate.model.page.elementfind.ElementFindByClassName;
 ...
 *
 */
public class FindByClassBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	protected @Nullable AbstractBeanDefinition parseInternal(@Nullable Element element,
        ...
        BeanDefinitionBuilder factory = BeanDefinitionBuilder.rootBeanDefinition(ElementFindByClassName.class);
