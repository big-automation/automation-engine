 ...
 *
 */
public class FindByLinkTextBeanDefinitionParser extends	AbstractBeanDefinitionParser {
	...
	protected @Nullable AbstractBeanDefinition parseInternal(@Nullable Element element,
        ...
        BeanDefinitionBuilder factory = BeanDefinitionBuilder.rootBeanDefinition(ElementFindByLinkText.class);
