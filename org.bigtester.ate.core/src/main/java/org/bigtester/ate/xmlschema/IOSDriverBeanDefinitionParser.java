...
import org.bigtester.ate.model.page.atewebdriver.MyIOSDriver;
 ...
 *
 */
public class IOSDriverBeanDefinitionParser extends
	...
	protected void doParse(@Nullable Element element,
		...
		String preserveCookies = element
				.getAttribute(XsdElementConstants.ATTR_IOSDRIVER_PRESERVECOOKIES);
		...
		String startArguments = element
				.getAttribute(XsdElementConstants.ATTR_IOSDRIVER_START_ARGUMENTS);
		if (!StringUtils.isEmpty(preserveCookies)) {
