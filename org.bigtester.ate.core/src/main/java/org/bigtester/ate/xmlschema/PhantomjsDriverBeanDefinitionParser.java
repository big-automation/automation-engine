...
import org.bigtester.ate.model.page.atewebdriver.MyPhantomjsDriver;
...
public class PhantomjsDriverBeanDefinitionParser extends
	 ...
	 * {@inheritDoc}
	 */
	protected Class<MyPhantomjsDriver> getBeanClass(@Nullable Element element) {
	        return MyPhantomjsDriver.class; 
    }
