 ...
 *
 */
public class WindowFindByOpenSequenceBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	protected @Nullable AbstractBeanDefinition parseInternal(@Nullable Element element,
        ...
        String openSeq = element.getAttribute(XsdElementConstants.ATTR_BROWSERWINDOWFINDBYOPENSEQUENCE_OPENSEQUENCE);
        BeanDefinitionBuilder factory = BeanDefinitionBuilder.rootBeanDefinition(TestWindowFindByOpenSequence.class);
